...
const OrdersScreen = ({navigation, route}) => {
  ...
  const orderdetails = async () => {
    ...
    console.log(
      'allOrdersData',
      JSON.stringify(allOrdersData.data.orders.historiesdata),
    );
            ...
            <View>
              ...
              <View
                ...
                <View
                  ...
                  {/* <Text style={{ color: "#2F6E8F" }}>Lorem ipsum</Text> */}
                  {/* <TouchableOpacity onPress={() => data.EDIT.open()}>
      <View style={{ flexDirection: "row" }}>
        <Image
                    ...
                    <View style={{ flexDirection: 'row' }}>
                      ...
                      <View style={{ flexDirection: 'column' }}>
                        <Text style={{
                          ...
                          fontFamily: "Poppins-Bold",
                          marginTop: 3
                        }}>{deliveryDetails ? deliveryDetails.provider.toUpperCase() : ''}</Text>
                        <Text style={{
                          marginLeft: 10,
                          fontSize: 12,
                          color: "black",
                          ...
                          fontFamily: "Poppins-Medium",
                          marginTop: 4
                        }}>{deliveryDetails?.rider_details ? deliveryDetails.rider_details.driver_name : ''}</Text>
                        <TouchableOpacity onPress={() => dialCall(`+${deliveryDetails.rider_details.mobile}`)}>
                          <Text style={{
                            marginLeft: 10,
                            fontSize: 12,
                            color: "black",
                            ...
                            fontFamily: "Poppins-Medium",
                            marginTop: 5
                          }}>{deliveryDetails ? deliveryDetails.rider_details.mobile : ''}  </Text>
                        </TouchableOpacity>
                        <Text style={{
                          marginLeft: 10,
                          fontSize: 12,
                          ...
                          fontFamily: "Poppins-Medium",
                          marginTop: 5
                        }}>{deliveryDetails ? deliveryDetails.rider_details.vehicle_number : ''}</Text>
                        <Text style={{
                          marginLeft: 10,
                          fontSize: 12,
                          color: "black",
                          ...
                          fontFamily: "Poppins-Medium",
                          marginTop: 4
                        }}>{deliveryDetails ? deliveryDetails.merchant_order_id : ''}</Text>
                      </View>
                    </View>
                  </View>
                } */}
