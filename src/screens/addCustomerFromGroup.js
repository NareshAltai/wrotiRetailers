...
const AddCustomerFromGroup = ({navigation, route}) => {
  ...
  const addnewcustomer = async () => {
    ...
    if (
      !isNaN(FirstName[0]) ||
      !/^[a-zA-Z][a-zA-Z0-9\s]*$/.test(FirstName[0]) ||
      FirstName.trim() == '' ||
      FirstName[0] === '-' ||
      FirstName[0] === '@' ||
      FirstName[0] === '.'
      ...
      Toast.showWithGravity(
        'First name cannot accept negitive value, special character or spaces',
        Toast.LONG,
        Toast.BOTTOM,
      );
      setIsLoading(false);
    ...
    if (
      !isNaN(LastName[0]) ||
      !/^[a-zA-Z][a-zA-Z0-9\s]*$/.test(LastName[0]) ||
      LastName.trim() == '' ||
      LastName[0] === '-' ||
      LastName[0] === '@' ||
      LastName[0] === '.'
      ...
      Toast.showWithGravity(
        'Last name cannot accept negitive value, special character or spaces',
        Toast.LONG,
        Toast.BOTTOM,
      );
      setIsLoading(false);
